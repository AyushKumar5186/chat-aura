...
useEffect(() => {
  ...
  return (
    <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-2  border-[#2f303b] w-full">
      ...
      <div className="my-5">
        <div className="flex text-center justify-between pr-10">
...
const Logo = () => {
  return (
    <div className="flex p-5  justify-start items-center gap-2">
      ...
      <span className="text-3xl font-semibold ">Chat Aura</span>
    </div>
  );
};
...
const Title = ({text}) => {
  return (
    <h6 className="uppercase tracking-widest text-neutral-400 pl-10 font-light text-opacity-90 tex-sm ">{text}</h6>
  )
}